...
public class CategoryController {
     ...
     */
    @PostMapping
    public Result<Long> createCategory(@RequestBody CategoryDTO dto) {
        Long userId = SecurityContext.requireUserId();
    ...
    public Result<Void> deleteCategory(
            ...
            @RequestParam(required = false) Long migrateToId) {
    ...
    public Result<Void> migrateCategory(@PathVariable Long id, @RequestBody CategoryMigrateDTO dto) {
     ...
     */
    @GetMapping("/{id}/usage")
    public Result<Map<String, Object>> getCategoryUsageCount(@PathVariable Long id) {
    ...
    public Result<List<CategoryVO>> getMigrationOptions(@PathVariable Long id) {
        Long userId = SecurityContext.requireUserId();
